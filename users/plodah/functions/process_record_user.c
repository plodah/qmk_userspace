...
#   if defined(PLODAH_KNOB_ENHANCEMENTS_ENABLE)
      ...
      /*case PL_ENC_PRS:
        if (record->event.pressed) {
          enc_prs_act(ctl_pressed, gui_pressed, alt_pressed, sft_pressed);
        }
        return false;
      case PL_ENC_CCW:
        if (record->event.pressed) {
          enc_ccw_act(ctl_pressed, gui_pressed, alt_pressed, sft_pressed);
        }
        return false;
      case PL_ENC_CW:
        if (record->event.pressed) {
          enc_cw_act(ctl_pressed, gui_pressed, alt_pressed, sft_pressed);
        }
        return false;
      */
      case PL_ENC_CCW:
