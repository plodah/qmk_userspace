...
#define P_SPCSY LT(_SYM, KC_SPC)
#define P_SPCNA LT(_NAV, KC_SPC)
...
#define P_ENTSY LT(_SYM, KC_ENT)
#define P_ENTNA LT(_NAV, KC_ENT)
#define P_HOMFC LT(_FNC, KC_HOME)
#define P_HOMMS LT(_MSE, KC_HOME)
#define P_ENDFC LT(_FNC, KC_END)
#define P_ENDMS LT(_MSE, KC_END)
#define P_FNA MO(_FNA)
#define P_FNB MO(_FNB)
#define P_FNC MO(_FNC)
#define P_FND MO(_FND)
#define P_SYM MO(_SYM)
#define P_NAV MO(_NAV)
#define P_MSE MO(_MSE)
#define P_RGB MO(_RGB)
...
#define P_MS5FA LT(_FNA, MS_BTN5)
