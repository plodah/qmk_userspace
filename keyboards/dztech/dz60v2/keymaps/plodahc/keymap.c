...
#define P_SPCM3 LT(3, KC_SPC)
#define P_BSPM3 LT(3,KC_BSPC)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_60_b_iso(
        PL_RAGE, KC_1,    KC_2,    KC_3,    KC_4,   TD(TD_F5), KC_6,   KC_7,    KC_8,    KC_9,    KC_0,  TD(TD_F11), KC_EQL, XXXXXXX, KC_BSPC,
        KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC,
        P_BSPM3, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, KC_NUHS, KC_ENT,
        KC_LSFT, KC_NUBS, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  P_SFTSL,          KC_UP,   KC_SLSH,
        KC_LCTL, KC_LGUI, KC_LALT,          P_SPCM2,          P_SPCM3,          P_SPCM2,          P_ALAPP, KC_RCTL, KC_LEFT, KC_DOWN, KC_RGHT
    ),
    [1] = LAYOUT_60_b_iso(
        PL_RAGE, KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,  XXXXXXX, KC_BSPC,
        KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC,
