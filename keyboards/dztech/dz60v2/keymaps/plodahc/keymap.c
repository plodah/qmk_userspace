...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [3] = LAYOUT_60_b_iso(KC_GRV, MC_1, MC_2, MC_3, MC_4, MC_5, MC_6, MC_7, MC_8, PL_QFTR, PL_QRGB, PL_QVER, QK_MAKE, KC_NO, KC_DEL, BL_TOGG, BL_BRTG, BL_UP, _______, _______, RGB_SPI, _______, _______, _______, _______, KC_PSCR, _______, _______, KC_CAPS, BL_BRTG, BL_DOWN, _______, _______, RGB_SPD, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, C(S(KC_V)), _______, NK_TOGG, _______, _______, _______, _______, KC_VOLU, _______, _______, GU_TOGG, _______, KC_SPC, KC_SPC , KC_SPC, KC_APP, _______, KC_HOME, KC_VOLD, KC_END),
