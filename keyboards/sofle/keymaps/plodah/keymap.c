...
[_FN_A] = LAYOUT(
  ...
  _______, _______, _______, _______, _______, KC_CAPS,                       KC_PGDN, KC_LEFT, KC_DOWN, KC_RGHT, _______, _______,
  _______, _______, _______, _______, _______, _______,PL_ENC_PRS,PL_ENC_PRS, _______, _______, _______, _______, _______, _______,
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][NUM_DIRECTIONS] = {
    ...
    [_COLEMAK] = {ENCODER_CCW_CW(PL_ENC_CCW, PL_ENC_CW), ENCODER_CCW_CW(PL_ENC_CCW, PL_ENC_CW)},
    [_FN_A] = {ENCODER_CCW_CW(PL_ENC_CCW, PL_ENC_CW), ENCODER_CCW_CW(PL_ENC_CCW, PL_ENC_CW)},
    [_FN_B] = {ENCODER_CCW_CW(PL_ENC_CCW, PL_ENC_CW), ENCODER_CCW_CW(PL_ENC_CCW, PL_ENC_CW)},
};
