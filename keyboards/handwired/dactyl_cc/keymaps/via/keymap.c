...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_SYS] = LAYOUT(
        ...
        _______, KC_VOLU, KC_WBAK, MS_UP,   KC_WFWD, KC_WH_U,                                         _______, KC_NO,   KC_NO,   KC_NO,  KC_NO,   _______,
        _______, KC_MUTE, MS_LEFT, MS_DOWN, MS_RGHT, KC_WH_D,                                         _______, KC_PSCR, KC_PAUS, KC_INS, KC_SCRL, _______,
