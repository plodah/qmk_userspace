...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWEA] = LAYOUT_iso_83(
        ...
        KC_LSFT, KC_NUBS, BRM_ZG,  BRM_XA,  BRM_CS,  BRM_VC,  BRM_BG,  BRM_NG,  BRM_MC,  BRM_COS, BRM_DOA, BRM_SLG, KC_RSFT, KC_UP,
    ...
    [_FNA] = LAYOUT_iso_83(
        ...
        _______, _______, _______, MS_BTN1, MS_BTN1, MS_BTN1, MS_BTN1, MS_BTN1, MS_BTN1, MS_BTN1, _______, _______, _______, KC_PGUP,
