...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_iso_83(
        ...
        KC_LCTL,  KC_LGUI,  KC_LALT,                                LT(1,KC_SPC),                          KC_RALT, LT(2, KC_APP), KC_RCTL,  KC_LEFT,  KC_DOWN,  KC_RGHT),
    ...
    [1] = LAYOUT_iso_83(
        ...
        RGB_TOG,  RGB_MOD,  RGB_VAI,  RGB_HUI,  RGB_SAI,  RGB_SPI,  _______,  _______,  _______,  _______,  KC_PSCR,  _______,    _______,                      C(KC_F4),
        KC_CAPS,  RGB_RMOD, RGB_VAD,  RGB_HUD,  RGB_SAD,  RGB_SPD,  _______,  _______,  _______,  _______,  _______,  _______,    _______,  _______,           S(C(KC_T)),
    ...
    [2] = LAYOUT_iso_83(
        ...
        KC_MC00,  KC_MC01,  KC_MC02,  KC_MC03,  KC_MC04,  KC_MC05,  KC_MC06,  KC_MC07,  KC_MC08,  KC_MC09,  KC_MC10,  KC_MC11,  KC_MC12,  _______,           KC_END,
        ...
        _______,  GU_TOGG,  _______,                                 KC_SPC,                                KC_APP,   _______,  _______,  KC_HOME, KC_VOLD,  KC_END),
