...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [MAC_FN] = LAYOUT_iso_90(
        ...
        _______,    RM_TOGG,  RM_NEXT,  RM_VALU,  RM_HUEU,  RM_SATU,  RM_SATU,   _______,  _______,  _______,  _______,  _______,  _______,  _______,                      _______,
        _______,    _______,  RM_PREV,  RM_VALD,  RM_HUEU,  RM_SATD,  RM_SATD,   _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,            _______,
