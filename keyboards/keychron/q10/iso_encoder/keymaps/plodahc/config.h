...
#define PLODAH_LAYER_INDIC_GRVINDEX 16
...
#  ifdef CAPS_WORD_BOTH_SHIFTS_TURNS_ON
#  undef CAPS_WORD_BOTH_SHIFTS_TURNS_ON
#  endif
#  define CAPS_WORD_BOTH_SHIFTS_TURNS_ON
#  ifdef CAPS_WORD_DOUBLE_TAP_SHIFT_TURNS_ON
#  undef CAPS_WORD_DOUBLE_TAP_SHIFT_TURNS_ON
#  endif
