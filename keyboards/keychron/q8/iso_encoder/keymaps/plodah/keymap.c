...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_QWEB] = LAYOUT_iso_70(
        ...
        KC_LCTL, KC_LWIN,          KC_LALT,          KC_SPC,  P_FNB,   P_FNA,            KC_SPC,           KC_RCTL,          KC_LEFT, KC_DOWN, KC_RGHT
    ),
    [_FNA] = LAYOUT_iso_70(
        KC_GRV,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,            KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_DEL,  PL_ECPR,
        KC_ENT,  KC_HOME, KC_UP,   KC_END,  KC_PGUP, _______,          KC_PGUP, KC_HOME, KC_UP,   KC_END,  KC_PSCR, _______, _______,          KC_PGUP,
        KC_CAPS, KC_LEFT, KC_DOWN, KC_RGHT, KC_PGDN, _______,          KC_PGDN, KC_LEFT, KC_DOWN, KC_RGHT, _______, _______, _______, _______, KC_PGDN,
        _______, _______, _______, _______, MS_BTN1, MS_BTN1, MS_BTN1, MS_BTN1, MS_BTN1, MS_BTN1, MS_BTN1, _______, _______, _______, KC_PGUP,
        _______, GU_TOGG,          _______,          KC_SPC,  _______, _______,          KC_SPC,           _______,          KC_HOME, KC_PGDN, KC_END
    ),
    [_FNB] = LAYOUT_iso_70(
        KC_GRV,  MC_1,    MC_2,    MC_3,    MC_4,    MC_5,             MC_6,    MC_7,    MC_8,    CM_QFTR, CM_QRGB, CM_QVER, QK_MAKE, KC_DEL,  PL_ECPR,
        RM_TOGG, RM_NEXT, RM_VALU, RM_HUEU, RM_SATU, RM_SPDU,          _______, _______, _______, _______, KC_PSCR, _______, _______,          CM_MSJG,
        _______, RM_PREV, RM_VALD, RM_HUED, RM_SATD, RM_SPDD,          _______, _______, _______, _______, _______, _______, _______, _______, _______,
        _______, _______, _______, _______, _______, P_PSTU,  _______, _______, NK_TOGG, _______, _______, _______, _______, _______, KC_VOLU,
        _______, GU_TOGG,          _______,          KC_SPC,  _______, _______,          KC_SPC,           _______,          KC_HOME, KC_PGDN, KC_END
    )
};
