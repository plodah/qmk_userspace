...
#define PLODAH_MODS_INDIC_LCTL_INDEX 13
#define PLODAH_MODS_INDIC_LGUI_INDEX 16
#define PLODAH_MODS_INDIC_LALT_INDEX 15
#define PLODAH_MODS_INDIC_LSHIFT_INDEX 14
#define PLODAH_MODS_INDIC_RCTL_INDEX 40
#define PLODAH_MODS_INDIC_RGUI_INDEX 43
#define PLODAH_MODS_INDIC_RALT_INDEX 42
#define PLODAH_MODS_INDIC_RSHIFT_INDEX 41
#define PLODAH_MODS_INDIC_HSV 240, 84, 255
#define PLODAH_GULOCK_INDIC_ENABLE

#define PLODAH_LAYER_INDIC_INDEXES { 4, 3, 2, 1, 0, 53, 52, 51, 50, 49 }
...
// #define PLODAH_LAYER_INDIC_BG_HSV HSV_ORANGE
  ...
  #define PLODAH_DMAC_INDIC_INDEX 47
  #define PLODAH_DMAC_INDIC_HSV HSV_RED
#endif

#define PLODAH_TYPINGINDICATOR_RGBINDEX 48
...
#define PLODAH_TYPINGINDICATOR_DURATION 600
  ...
  #define MSJIGGLER_INDICATOR_RGBINDEX 35
