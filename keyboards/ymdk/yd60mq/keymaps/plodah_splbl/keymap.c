...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWEA] = LAYOUT_all(
        ...
        KC_LSFT, KC_NUBS, BRM_ZG,  BRM_XA,  BRM_CS,  BRM_VC,  BRM_BG,  BRM_NG,  BRM_MC,  BRM_COS, BRM_DOA, P_SLSFT, XXXXXXX, KC_UP,   KC_SLSH,
    ...
    [_FNA] = LAYOUT_all(
        ...
        _______, _______, _______, KC_BTN1, KC_BTN1, KC_BTN1, KC_BTN1, KC_BTN1, KC_BTN1, KC_BTN1, _______, _______, XXXXXXX, KC_PGUP, _______,
