...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_LAYERB] = LAYOUT_ortho_5x14(
        UG_TOGG , UG_HUED  ,UG_HUEU   ,UG_SATD   , UG_SATU  , UG_VALD  , UG_VALU  ,                       RGB_M_P  , RGB_M_B   , RGB_M_R    , RGB_M_SW    , RGB_M_K   , RGB_M_TW   , RGB_M_G ,
        KC_TRNS , KC_TRNS, KC_TRNS   ,KC_TRNS   , KC_TRNS  , KC_TRNS  , KC_TRNS  ,              KC_TRNS  , KC_TRNS , MS_BTN1    , KC_MS_U    , MS_BTN2   , KC_TRNS   ,KC_TRNS,
